...
import com.white.security.browser.support.SocialUserInfo;
...
public class BrowserSecurityController {
    ...
    public SimpleResponse requireAuthenication(HttpServletRequest request, HttpServletResponse response) throws IOException {
